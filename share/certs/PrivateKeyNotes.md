...
unlocked to sign the Dinarcoin-Qt.app bundle.
...
allowing somebody to distribute a Dinarcoin-Qt.app or bitcoin-qt-setup.exe with a valid
...
that the dinarcoin-qt.exe file inside the installer had not been tampered with.
